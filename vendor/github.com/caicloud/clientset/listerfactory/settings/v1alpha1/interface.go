...
type Interface interface { // PodPresets returns a PodPresetLister
	PodPresets() v1alpha1.PodPresetLister
}
...
// PodPresets returns a PodPresetLister.
func (v *version) PodPresets() v1alpha1.PodPresetLister {
	return &podPresetLister{client: v.client, tweakListOptions: v.tweakListOptions}
}

// PodPresets returns a PodPresetLister.
func (v *infromerVersion) PodPresets() v1alpha1.PodPresetLister {
	return v.factory.Settings().V1alpha1().PodPresets().Lister()
}
