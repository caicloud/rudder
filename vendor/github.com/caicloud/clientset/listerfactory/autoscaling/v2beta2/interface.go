...
type Interface interface { // HorizontalPodAutoscalers returns a HorizontalPodAutoscalerLister
	HorizontalPodAutoscalers() v2beta2.HorizontalPodAutoscalerLister
}
...
func (v *version) HorizontalPodAutoscalers() v2beta2.HorizontalPodAutoscalerLister {
	return &horizontalPodAutoscalerLister{client: v.client, tweakListOptions: v.tweakListOptions}
}

// HorizontalPodAutoscalers returns a HorizontalPodAutoscalerLister.
func (v *infromerVersion) HorizontalPodAutoscalers() v2beta2.HorizontalPodAutoscalerLister {
	return v.factory.Autoscaling().V2beta2().HorizontalPodAutoscalers().Lister()
}
