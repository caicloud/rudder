...
import (
	...
	v2beta2 "github.com/caicloud/clientset/listerfactory/autoscaling/v2beta2"
...
type Interface interface {
	...
	// V2beta2 provides access to listers for resources in V2beta2.
...
func (g *group) V2beta2() v2beta2.Interface {
	return v2beta2.New(g.client, g.tweakListOptions)
}

func (g *informerGroup) V2beta2() v2beta2.Interface {
	return v2beta2.NewFrom(g.factory)
}
