...
type Interface interface { // PriorityClasses returns a PriorityClassLister
	PriorityClasses() v1.PriorityClassLister
}
...
func (v *version) PriorityClasses() v1.PriorityClassLister {
	return &priorityClassLister{client: v.client, tweakListOptions: v.tweakListOptions}
}

// PriorityClasses returns a PriorityClassLister.
func (v *infromerVersion) PriorityClasses() v1.PriorityClassLister {
	return v.factory.Scheduling().V1().PriorityClasses().Lister()
}
