...
import (
	...
	coordination "github.com/caicloud/clientset/listerfactory/coordination"
...
func (f *clientListerFactory) Coordination() coordination.Interface {
	return coordination.New(f.client, f.tweakListOptions)
}
...
func (f *informerListerFactory) Coordination() coordination.Interface {
	return coordination.NewFrom(f.factory)
}
