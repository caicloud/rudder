...
type Interface interface { // RuntimeClasses returns a RuntimeClassLister
	RuntimeClasses() v1beta1.RuntimeClassLister
}
...
func (v *version) RuntimeClasses() v1beta1.RuntimeClassLister {
	return &runtimeClassLister{client: v.client, tweakListOptions: v.tweakListOptions}
}

// RuntimeClasses returns a RuntimeClassLister.
func (v *infromerVersion) RuntimeClasses() v1beta1.RuntimeClassLister {
	return v.factory.Node().V1beta1().RuntimeClasses().Lister()
}
