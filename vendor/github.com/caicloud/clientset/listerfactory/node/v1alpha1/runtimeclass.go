...
var _ v1alpha1.RuntimeClassLister = &runtimeClassLister{}
...
func NewRuntimeClassLister(client kubernetes.Interface) v1alpha1.RuntimeClassLister {
	return NewFilteredRuntimeClassLister(client, nil)
}

func NewFilteredRuntimeClassLister(client kubernetes.Interface, tweakListOptions internalinterfaces.TweakListOptionsFunc) v1alpha1.RuntimeClassLister {
...
func (s *runtimeClassLister) List(selector labels.Selector) (ret []*nodev1alpha1.RuntimeClass, err error) {
	...
	list, err := s.client.NodeV1alpha1().RuntimeClasses().List(listopt)
	if err != nil {
		return nil, err
	}
...
func (s *runtimeClassLister) Get(name string) (*nodev1alpha1.RuntimeClass, error) {
	return s.client.NodeV1alpha1().RuntimeClasses().Get(name, v1.GetOptions{})
}
