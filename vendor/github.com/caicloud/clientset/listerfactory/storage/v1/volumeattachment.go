...
var _ v1.VolumeAttachmentLister = &volumeAttachmentLister{}
...
func NewVolumeAttachmentLister(client kubernetes.Interface) v1.VolumeAttachmentLister {
	return NewFilteredVolumeAttachmentLister(client, nil)
}

func NewFilteredVolumeAttachmentLister(client kubernetes.Interface, tweakListOptions internalinterfaces.TweakListOptionsFunc) v1.VolumeAttachmentLister {
...
func (s *volumeAttachmentLister) List(selector labels.Selector) (ret []*storagev1.VolumeAttachment, err error) {
	...
	list, err := s.client.StorageV1().VolumeAttachments().List(listopt)
	if err != nil {
		return nil, err
	}
...
func (s *volumeAttachmentLister) Get(name string) (*storagev1.VolumeAttachment, error) {
	return s.client.StorageV1().VolumeAttachments().Get(name, metav1.GetOptions{})
}
