...
func (g *GenScheme) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"schemeScheme":                     c.Universe.Variable(types.Name{Package: "k8s.io/client-go/kubernetes/scheme", Name: "Scheme"}),
		"schemeCodecs":                     c.Universe.Variable(types.Name{Package: "k8s.io/client-go/kubernetes/scheme", Name: "Codecs"}),
		"schemeParameterCodec":             c.Universe.Variable(types.Name{Package: "k8s.io/client-go/kubernetes/scheme", Name: "ParameterCodec"}),
		"fakeAddToScheme":                  c.Universe.Function(types.Name{Package: "k8s.io/client-go/kubernetes/fake", Name: "AddToScheme"}),
		"Fake":                             g.Fake,
	}
