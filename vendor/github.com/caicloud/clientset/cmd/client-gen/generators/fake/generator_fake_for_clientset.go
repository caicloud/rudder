...
func (g *genClientset) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		"Clientset": c.Universe.Type(types.Name{Package: "k8s.io/client-go/kubernetes/fake", Name: "Clientset"}),
	}
	sw.Do(common, m)
	sw.Do(checkImpl, nil)
...
func NewSimpleClientset(objects ...runtime.Object) *Clientset {
	...
	return &Clientset{&$.Clientset|raw${Fake:fakePtr}, &fakediscovery.FakeDiscovery{Fake: &fakePtr}}
}
