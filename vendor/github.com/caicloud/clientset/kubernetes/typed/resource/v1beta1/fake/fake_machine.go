...
var machinesResource = schema.GroupVersionResource{Group: "resource.caicloud.io", Version: "v1beta1", Resource: "machines"}

var machinesKind = schema.GroupVersionKind{Group: "resource.caicloud.io", Version: "v1beta1", Kind: "Machine"}
...
func (c *FakeMachines) Get(name string, options v1.GetOptions) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(machinesResource, name), &v1beta1.Machine{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachines) List(opts v1.ListOptions) (result *v1beta1.MachineList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(machinesResource, machinesKind, opts), &v1beta1.MachineList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachines) Create(machine *v1beta1.Machine) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(machinesResource, machine), &v1beta1.Machine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Machine), err
...
func (c *FakeMachines) Update(machine *v1beta1.Machine) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(machinesResource, machine), &v1beta1.Machine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Machine), err
...
func (c *FakeMachines) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(machinesResource, name), &v1beta1.Machine{})
	return err
}
...
func (c *FakeMachines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(machinesResource, name, data, subresources...), &v1beta1.Machine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Machine), err
