...
var releasesResource = schema.GroupVersionResource{Group: "release.caicloud.io", Version: "v1alpha1", Resource: "releases"}

var releasesKind = schema.GroupVersionKind{Group: "release.caicloud.io", Version: "v1alpha1", Kind: "Release"}
